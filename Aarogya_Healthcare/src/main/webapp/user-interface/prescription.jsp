...
try {
     ...
     String getTotalPrescription = "SELECT COUNT(*) FROM prescription WHERE registered_users_email_address = \"" + registered_users_email_address + "\" AND refill > 0";
...
<div class="query-records-container" style="border-top-left-radius: 10px;">					
	<table>
		...
		<%
		String newAppointments = "SELECT * FROM prescription WHERE registered_users_email_address = \"" + registered_users_email_address + "\" AND refill > 0";
